...
"Inteligência sem memória é improviso. Memória organizada transforma experiência em conhecimento."
 
   "Inteligência sem memória é improviso.
    Memória organizada transforma experiência em conhecimento."
         "Primeiro aprendemos a guardar.
          Depois aprendemos a lembrar.
          Só então aprendemos a pensar."

   Quem guarda apenas dados acumula arquivos.
   Quem organiza experiências constrói sabedoria."
  "Toda inteligência nasce da experiência. Toda experiência nasce da memória."
...
RITUAL PREPARAÇÃO MENTAL DE OPERADOR CÚ DE SUVELA 
...
Mensagem contextual
(com efeito datilografado)

↓

Pequena animação ou contexto visual

↓

Reflexão de 10 a 15 segundos

↓

Carregamento da Biblioteca Histórica

↓

Abertura do painel TRIN
